  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-blue-50">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 via-blue-500 to-orange-400 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 leading-tight">Descubra a Paraíba</h1>
            <p className="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto px-4">
              Encontre o aluguel perfeito na cidade onde o sol nasce primeiro. Praias paradisíacas, cultura rica e
              hospitalidade única te esperam.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Reserva Segura</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">Pagamento protegido e cancelamento flexível</p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Qualidade Garantida</h3>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Suporte 24/7</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">Atendimento disponível a qualquer hora</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Propriedades em Destaque</h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Descubra os melhores aluguéis na Paraíba, desde apartamentos com vista para o mar até casas
              aconchegantes no centro histórico.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {featuredProperties.map((property) => (
              <Card
                key={property.id}
                className="group hover:shadow-xl transition-all duration-300 border-orange-100 hover:border-orange-200 overflow-hidden"
              >
                <div className="relative">
                  <Image
                  ...
                  <Badge className="absolute top-3 left-3 bg-orange-500 hover:bg-orange-600 text-xs">Destaque</Badge>
                </div>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Somos especialistas na Paraíba e oferecemos a melhor experiência para sua estadia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Localização Privilegiada</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">
            ...
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Comodidades Modernas</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">WiFi, ar-condicionado e tudo que você precisa</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Estacionamento Seguro</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">Vagas garantidas para sua tranquilidade</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Experiência Local</h3>
              <p className="text-sm sm:text-base text-gray-600 px-2">Dicas exclusivas dos melhores lugares da cidade</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Sua melhor opção para aluguéis na Paraíba. Descubra a cidade onde o sol nasce primeiro.
              </p>
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-4">Propriedades</h3>
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-4">Suporte</h3>
              <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
                <li>
                  <Link href="#" className="hover:text-white">
                    Central de Ajuda
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-4">Empresa</h3>
              <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
                <li>
                  <Link href="#" className="hover:text-white">
                    Sobre Nós
          ...
          <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-gray-400">
            <p className="text-sm sm:text-base">&copy; 2025 A definir. Todos os direitos reservados.</p>
